...
export class WaterComponent implements OnInit {
    ...
    public update_water_data =new Array(); //对比后修改的数据
    ...
    getChildEvent1(event){
        ...
        this.name_active_data['list'] = JSON.parse(JSON.stringify(this.init_water_data['baseList']));
        ...
        if((typeof this.waterList) != 'undefined' && this.waterList.length>0){
            this.waterList.push(new TreesData('','','','','','','','','',event,'','','','','',0,'','','','','','','','',name,'','',''));
    ...
    deleteSlect(){
        ...
        // if(this.waterList[0] != undefined && this.name_active_key>0){
        console.log(this.name_active_data);
